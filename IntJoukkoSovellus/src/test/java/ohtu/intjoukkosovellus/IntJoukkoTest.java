...
public class IntJoukkoTest {
    ...
    public void lukujaLisattyMaara() {
        joukko.lisaaLuku(4);
        assertEquals(3, joukko.getJoukonKoko());
    }
    ...
    public void samaLukuMeneeJoukkoonVaanKerran() {
        joukko.lisaaLuku(10);
        joukko.lisaaLuku(3);
        assertEquals(2, joukko.getJoukonKoko());
    }
    ...
    public void poistettuEiOleEnaaJoukossa() {
        ...
        assertEquals(1, joukko.getJoukonKoko());
    }
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertEquals(14, joukko.getJoukonKoko());
        assertTrue(joukko.sisaltaaLuvun(11));
        joukko.poista(11);
        assertFalse(joukko.sisaltaaLuvun(11));
        assertEquals(13, joukko.getJoukonKoko());
    }
